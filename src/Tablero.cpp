#include "Tablero.h"
    ...
    Tablero::Coordenada *obtenerPosicionAleatoria()
    {
    ...
    Tablero::TipoTerreno getTerreno(Coordenada *ubicacion)
    {
    ...
    Tablero::void insertar(Unidad *elemento)
    {
    ...
    Tablero::void colococarAleatoriamente(Unidad *nuevaUnidad)
    {
        bool buscando = true;
